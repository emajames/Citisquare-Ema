<template>
  ...
  <section class="form">
      <div class="form2">
       ...
       <hr>
      <div class="form1"> 
          <h2 class="create pb-4 pb-4">Create A Merchant Account</h2>
      ...
      <form method="post">
        ...
        <div class="footsie">
            <div>
              <a href="/createaccount"><button class="sign_btn mt-1" >Sign Up As A Customer</button></a>
          </div>
 
          <h6 class="text-center already_acct pt-3">Already have an account? <a href="">Login</a></h6>
