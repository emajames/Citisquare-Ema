<template>
  <section class="forgot">
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <a class="nav-link" href="#" style="color: #4F4F4F;">Have an account?</a>
  ...
  <section class="form mt-3">
      ...
      <form method="post">
           <div>      
              <button class="google_btn"><img class="google_img" src="@/assets/Glogo.png" alt="">Sign up with Google</button>   
          </div>

          <div>      
              <button class="google_btn"><img class="google_img" src="@/assets/facebook-logo.png" alt="">Sign up with Facebook</button>   
          </div>

          <div>      
              <button class="google_btn"><img class="google_img" src="@/assets/Apple_logo_black.svg.png" alt="">Sign up with Apple</button>   
          </div>
          
           
           <div style="float:left; width: 44%; padding-top: 1.2rem"><hr/></div>
           <div style="float:right; width: 44%; padding-top: 1.2rem"><hr/></div>
             <div class="mb-3" style="padding-top: 0.5rem;color: #B0B7C3;fontweight:600; text-align:center;paddding-bottom:1rem">OR</div>
          ...
          <div class="inputContainer mt-4">
           ...
           <div class="inputContainer mt-4">
               ...
               <span class="eye">
                    ...
                    <FontAwesomeIcon :icon="['fa-solid', 'fa-eye-slash']" class="icon"/>
               </span>   
          </div>
 
           <div class="checkbox d-flex align-items-center mt-4">
               <input type="checkbox" id="cb1">
               <label for="cb1" class="pr-3 check_text"> I agree to the Terms & Conditions</label>
           </div>
          ...
          <div class="footsie">
              <a href="/Merchantsignup"><button class="sign_btn mt-1">Sign Up As A Merchant</button></a>
          </div>
 
          <h6 class="text-center already_acct pt-3">Already have an account? <a href="/login">Login</a></h6>
  ...
  <footer class="container">
      ...
      <div class="footer2">
          <a href="#">Terms</a> <a href="">Privacy</a> <a href="">Security</a> <a href="">Get in touch</a>
      </div>
  </footer>
    </section>
</template>
...
<style>
.forgot{
        background: url("../assets/password.svg") center center/cover;
        height: 100%;
    }
    .navbar {
